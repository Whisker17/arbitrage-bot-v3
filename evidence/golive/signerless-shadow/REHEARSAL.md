...
Observed (all `FORBIDDEN_ENV_VAR_NAMES` + hot/guardian keys):

```
STRIPPED MANTLE_SEPOLIA_PRIVATE_KEY=absent
STRIPPED MANTLE_MAINNET_PRIVATE_KEY=absent
STRIPPED MANTLE_PRIVATE_KEY=absent
STRIPPED PRIVATE_KEY=absent
STRIPPED EXECUTION_PRIVATE_KEY=absent
STRIPPED BOT_HOT_EXECUTOR_PRIVATE_KEY=absent
STRIPPED BOT_GUARDIAN_PRIVATE_KEY=absent
STRIPPED BOT_ENABLE_SENDS=absent
SHADOW_MODE=1
