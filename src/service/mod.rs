...
pub use block_loop::{
    ...
    require_matching_ready_tip, resolve_http_tip_wait, resolve_pinned_logs_retry,
    run_multi_protocol_watch_loop, subscribe_heads_once, tip_refresh_full_reason,
    tip_refresh_gap_log_range, tip_refresh_gap_size, tip_refresh_requires_full,
    tip_refresh_scope_for_head, union_tip_refresh_dirty, wait_for_shutdown_signal, BlockSkipReason,
    BlockTick, CanonicalHeaderLoad, ExecutionJob, HeadSource, HeadSubscription, JobSlot,
    NoopWatchHooks, ProcessHeadResult, RebaselineKind, SkipRatioSignal, SkipRatioTracker,
    TipRefreshFullReason, WatchLoopConfig, WatchLoopHooks, WatchLoopState, WatchLoopStats,
    DEFAULT_EMPTY_LOG_CANARY_BLOCKS, DEFAULT_HTTP_POLL_INTERVAL, DEFAULT_HTTP_TIP_WAIT,
    DEFAULT_PINNED_LOGS_RETRY, DEFAULT_SKIP_FATAL_WINDOW, DEFAULT_SKIP_RATIO_THRESHOLD,
    DEFAULT_SKIP_RATIO_WINDOW, ENV_HTTP_TIP_WAIT_MS, ENV_PINNED_LOGS_RETRY_MS, JOB_POLL_INTERVAL,
};
pub use config::{
